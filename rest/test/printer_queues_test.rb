...
describe PuavoRest::PrinterQueues do
  ...
  describe "GET /v3/printer_queues" do
    ...
    it "can filter printers by server" do
      ...
      assert_equal "http://example.puavo.net/v3/printer_queues/printer2/ppd", @data.first["ppd_link"]
      assert_equal "boot2.example.puavo.net", @data.first["server_fqdn"]
      assert_equal "socket://baz", @data.first["local_uri"]
      assert_equal "ipp://boot2.example.puavo.net/printers/printer2", @data.first["remote_uri"]
    end
  ...
  describe "GET http://example.puavo.net/v3/printer_queues/printer1/ppd" do
    it "returns ppd data" do
      basic_authorize "cucumber", "cucumber"
      get "http://example.puavo.net/v3/printer_queues/printer1/ppd"
      assert_200
