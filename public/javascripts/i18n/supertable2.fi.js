...
I18n.translations["fi"] = I18n.extend((I18n.translations["fi"] || {}),
{
    ...
    tabs: {
        ...
        columns: {
            title: "Sarakkeet",
            help: "Huomaathan, että voit järjestellä sarakkeita raahaamalla niiden otsakkeita taulukossa hiirellä (eli klikkaus=lajittele, raahaus=järjestele).",
            selected: "Valittu",
            total: "saraketta",
    ...
    filter_editor: {
        ...
        list: {
            ...
            explanation_column_not_visible_hover: "Tämä suodatin koskee saraketta joka ei ole näkyvissä. Suodatin saattaa huomaamatta piilottaa tai näyttää rivejä.",
        ...
        popup: {
            ...
            target_warning: "Tähdellä (*) merkityt sarakkeet eivät ole juuri nyt näkyvissä. Ole siksi varovainen, koska suodatin voi piilottaa tai näyttää ei-toivottuja rivejä ilman että huomaat asiaa.",
