Feature: Devices registration
  ...
  Scenario: Register new fatclient
    ...
    Given a process "puavo-register" from command "fakeroot --lib /usr/lib/x86_64-linux-gnu/libfakeroot/libfakeroot-sysv.so /usr/sbin/puavo-register --puavoserver http://127.0.0.1:37634 --nocolor"
