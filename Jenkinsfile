...
deb http://deb.nodesource.com/node_6.x buster main
deb-src http://deb.nodesource.com/node_6.x buster main
EOF
        '''
...
EOF
    ...
    stage('Prepare the puavo-standalone environment') {
      ...
      steps {
        ...
        sh '''
          wget -qO - https://github.com/puavo-org/puavo-standalone/raw/buster/setup.sh | sh
        '''
      }
    }
