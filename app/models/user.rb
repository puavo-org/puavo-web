...
class User < LdapBase
  ...
  ADMIN_PERMISSIONS = %i[
    ...
    user_edit_expiration_times user_mass_edit_expiration_times user_mass_change_locale
    ...
    device_edit_expiration_times device_mass_edit_expiration_times device_mass_set_db_fields device_mass_edit_puavoconf
  ].freeze
